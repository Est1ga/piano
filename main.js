...
if (audioEmExecucao != null) {
  ...
  const fadeOutInterval = 1; // Intervalo de tempo para diminuir o volume em cada etapa (em milissegundos)
  const fadeOutSteps = 8; // Número de etapas para diminuir o volume
